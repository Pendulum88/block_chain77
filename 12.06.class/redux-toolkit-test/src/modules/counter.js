  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(counterThunk.fulfilled, (state, action) => {
        // bulider의 addCase 메서드를 사용해서 각 작업에 대해 내용을 작성한다
        // fulfilled의 경우 reducer가 성공적으로 완료되었을시에 실행하는 작업이다
...
// dispatch의 action에 counterSlice로 생성된 actions를 사용한다

export const reducer = counterSlice.reducer;
// store에 reducer로 counterSlice로 생성된 reducer를 사용한다
